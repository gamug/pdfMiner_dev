...
import pandas as pd
from exploreText import explorePDF, textClassifier
...
try:
    ...
    setState(state, "Hello there SANDRA, please restart app again before continue.\n\n."
                    "If you don't restart application will failure on some task and you can't"
                    "get our two new filters")
    setState(state, '********************************************')
...
class textMiner():
    def __init__(self):
        ...
        #TO REMOVE IN NEXT UPGRADE
        self.setState(state, "Hello there SANDRA, please restart app again before continue.\n\n."
                             "If you don't restart application will failure on some task and you can't"
                             "get our two new filters")
        self.setState(state, '********************************************')
    ...
    def pdfMiner(self):
        ...
        database = explorePDF(self.workPath, self.state, self.filter)  # creating explorePDF object
        database.main()
        self.setState('********************************************')
